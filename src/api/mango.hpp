...
namespace mango {
  ...
  const algorithm_properties algorithms[NUM_ALGORITHMS] = {
    ...
    {                      "petsc_brgn",   PACKAGE_PETSC,          true,             true,     true,               false},
    ...
    {                          "gsl_lm",     PACKAGE_GSL,          true,             true,     true,               false},
    {                      "gsl_dogleg",     PACKAGE_GSL,          true,             true,     true,               false},
    {                     "gsl_ddogleg",     PACKAGE_GSL,          true,             true,     true,               false},
    {                  "gsl_subspace2d",     PACKAGE_GSL,          true,             true,     true,               false},
    {                "gsl_conjugate_fr",     PACKAGE_GSL,         false,             true,     true,               false},
    {                "gsl_conjugate_pr",     PACKAGE_GSL,         false,             true,     true,               false},
    {                        "gsl_bfgs",     PACKAGE_GSL,         false,             true,     true,               false},
    {                          "gsl_nm",     PACKAGE_GSL,         false,            false,    false,               false}
    // </database>
  };
