...
void mango::Package_nlopt::optimize(Problem* problem) {
#ifdef MANGO_NLOPT_AVAILABLE
  ...
  nlopt_opt opt = nlopt_create((nlopt_algorithm)mango_nlopt_algorithm, problem->get_N_parameters());
  //  nlopt_set_min_objective(opt, (nlopt_func) &mango::problem::nlopt_objective_function, (void*)this);
  nlopt_set_min_objective(opt, (nlopt_func) &mango::Package_nlopt::nlopt_objective_function, (void*)this);

  nlopt_set_maxeval(opt, problem->max_function_and_gradient_evaluations);
